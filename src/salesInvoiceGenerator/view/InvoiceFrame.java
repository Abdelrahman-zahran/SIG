...
public class InvoiceFrame extends JDialog {
    ...
    public InvoiceFrame(JTextField CustomerNameField, JTextField DateField, JLabel CustNameLabel, JLabel DateLabel, JButton OkayButton, JButton CancelButton)
    {
    ...
    public InvoiceFrame(BasicFrame Frame) {
