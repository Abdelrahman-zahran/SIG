...
public class ItemFrame extends JDialog{
    ...
    public ItemFrame(JTextField ItemNameField, JTextField ItemCountField, JTextField ItemPriceField, JLabel ItemNameLabel, JLabel ItemCountLabel, JLabel ItemPriceLabel, JButton OkayItemButton, JButton CancelItemButton)
    {
    ...
    public ItemFrame(BasicFrame frame) {
